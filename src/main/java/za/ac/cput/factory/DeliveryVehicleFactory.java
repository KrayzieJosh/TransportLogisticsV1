...
public class DeliveryVehicleFactory {
    public static DeliveryVehicle createDeliveryVehicle(String vehicleId, String vehicleName,String vehicleLicence, double vehicleLoadCapacity, boolean isAvailable) {
        ...
        if (Helper.isNullOrEmpty(vehicleId) || Helper.isNullOrEmpty(vehicleName) || Helper.isNullOrEmpty(vehicleLicence)|| Helper.isNullOrEmpty(String.valueOf(vehicleLoadCapacity))
        ...
        return new DeliveryVehicle.Builder()
                ...
                .setVehicleLicence(vehicleLicence)
